...
class ResultFormatter(BasePostProcessor):
    ...
    Example:
        from ocr2md.config import ResultFormatterConfig
    ...
    def format_ocr_result(self, content: str, page_idx: int = 0) -> Tuple[str, str]:
        ...
        markdown_str = normalize_markdown_output(content)
    ...
    def format_multi_page_results(self, contents: List[str]) -> Tuple[str, str]:
        ...
        markdown_str = normalize_markdown_output("\n\n---\n\n".join(markdown_parts))
    ...
    def _clean_content(self, content: str) -> str:
        ...
        content = normalize_fenced_code_block_spacing(content)
