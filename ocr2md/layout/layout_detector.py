...
class PPDocLayoutDetector(BaseLayoutDetector):
    ...
    def start(self):
        ...
        resolved_model_dir = resolve_model_dir_path(
            self.model_dir,
    ...
    def process(
        ...
        for chunk_start in range(0, num_images, self.batch_size):
            ...
            layout_results = apply_layout_postprocess(
        ...
        if save_visualization and visualization_output_dir:
            ...
            for img_idx, img_results in enumerate(all_layout_results):
        ...
        all_results = []
        for img_idx, layout_results in enumerate(all_layout_results):
